    ...
    <div className="min-h-screen bg-[#FAFAFA] text-slate-900 font-sans selection:bg-sky-100 selection:text-sky-900">
          ...
          <div className="mx-auto max-w-7xl text-center">
            ...
            <h1 className="mx-auto max-w-4xl text-4xl sm:text-6xl font-extrabold tracking-tight text-slate-900 mb-6 leading-[1.1]">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-600 to-violet-600">
                nous gérons votre réputation.
              </span>
            </h1>

            <p className="mx-auto max-w-2xl text-lg sm:text-xl text-slate-600 mb-10 leading-relaxed">
              Ne perdez plus vos soirées à répondre aux avis. Dynam8 automatise vos réponses, anime votre page Google et fait revenir vos clients.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 items-start">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex flex-col h-full">
                ...
                <blockquote className="text-slate-700 font-medium flex-1 leading-relaxed">
                  &ldquo;Je négligeais Google par manque de temps. C&rsquo;est devenu{" "}
                  <span className="bg-sky-50 text-sky-700 px-1 rounded font-bold">
                    un vrai levier d&rsquo;acquisition
                  </span>{" "}
                  et de fidélisation. Ma fiche tourne seule et m&rsquo;amène des clients.&rdquo;
                </blockquote>
                <div className="mt-6 flex items-center gap-3 pt-6 border-t border-slate-50 w-full">
                  <div className="size-10 rounded-full bg-sky-100 flex items-center justify-center text-xl">
                    👨‍🍳
                  </div>
                  <div>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex flex-col h-full">
                ...
                <blockquote className="text-slate-700 font-medium flex-1 leading-relaxed">
                  &ldquo;Ça me rassure énormément. Je ne me prends plus la tête :{" "}
                  <span className="bg-violet-50 text-violet-700 px-1 rounded font-bold">
                    ma page tourne toute seule
                  </span>
                  . Je gagne du temps et de la visibilité sans stress.&rdquo;
                </blockquote>
                <div className="mt-6 flex items-center gap-3 pt-6 border-t border-slate-50 w-full">
                  <div className="size-10 rounded-full bg-violet-100 flex items-center justify-center text-xl">
                    👩‍🍳
                  </div>
                  <div>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex flex-col h-full">
                ...
                <blockquote className="text-slate-700 font-medium flex-1 leading-relaxed">
                  &ldquo;La gestion des avis négatifs est bien plus simple.{" "}
                  <span className="bg-emerald-50 text-emerald-700 px-1 rounded font-bold">
                    L&rsquo;alerte WhatsApp immédiate
                  </span>{" "}
                  en cas de mauvaise note me permet de désamorcer les problèmes rapidement.&rdquo;
                </blockquote>
                <div className="mt-6 flex items-center gap-3 pt-6 border-t border-slate-50 w-full">
                  <div className="size-10 rounded-full bg-emerald-100 flex items-center justify-center text-xl">
                    🔧
                  </div>
                  <div>
          ...
          <div className="mx-auto max-w-3xl px-6">
            ...
            <div className="space-y-4">
              {faqs.map((f, i) => (
                <details
                  key={i}
                  className="group bg-slate-50 border border-slate-200 rounded-xl p-4 [&_summary::-webkit-details-marker]:hidden open:bg-white open:shadow-sm transition-all"
                >
            ...
            <div className="bg-white rounded-2xl p-2 sm:p-8 max-w-lg mx-auto text-slate-900 shadow-2xl">
              {sent === "ok" ? (
                <div className="py-12 text-center animate-in fade-in zoom-in">
                  ...
                  <p className="text-slate-600 mt-2">On vous appelle très vite.</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-4 text-left p-4">
                  <div>
                    ...
                    <input
                      ...
                      type="text"
                      name="name"
                      className="w-full rounded-lg border-slate-300 focus:ring-sky-500 focus:border-sky-500"
                  ...
                  <button
                    disabled={sending}
                    type="submit"
                    className="w-full bg-sky-600 hover:bg-sky-700 text-white font-bold py-3 rounded-lg transition flex items-center justify-center gap-2 mt-4 disabled:opacity-70"
                  >
      ...
      <div className="fixed bottom-4 left-4 right-4 z-50 sm:hidden">
        <div className="bg-slate-900/90 backdrop-blur-md text-white rounded-2xl shadow-2xl flex items-center p-1.5 border border-slate-800">
          <a
            href="#roi"
            className="flex-1 flex flex-col items-center justify-center py-2 rounded-xl active:bg-white/10"
          >
          ...
          <a
            href="#contact"
            className="flex-[2] bg-sky-600 rounded-xl flex items-center justify-center py-2.5 font-bold text-sm shadow-lg"
          >
    ...
    >
      <div className="mx-auto max-w-7xl px-6 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600">
          <a href="#solutions" className="hover:text-sky-600 transition">
            Solutions
          </a>
      ...
      {mobileOpen && (
        <div className="absolute top-full left-0 right-0 bg-white border-b border-slate-100 p-4 shadow-xl flex flex-col gap-4 text-lg font-medium md:hidden animate-in slide-in-from-top-5">
          ...
          <a
            href="#contact"
            onClick={() => setMobileOpen(false)}
            className="p-2 text-sky-600 font-bold"
          >
            Prendre RDV
          </a>
        </div>
...
function FeatureCard({
  ...
  return (
    ...
    >
      <div
        className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 ${colors[theme]
          .split(" ")
          .slice(0, 2)
          .join(" ")}`}
      >
  ...
  return (
    <div
      className={`relative rounded-2xl p-8 bg-white border ${
        isPopular
          ? "border-sky-600 ring-1 ring-sky-600 shadow-xl scale-105 z-10"
    ...
    >
      ...
      <h3 className={`text-lg font-semibold ${isPopular ? "text-sky-600" : "text-slate-900"}`}>
        {title}
      </h3>
